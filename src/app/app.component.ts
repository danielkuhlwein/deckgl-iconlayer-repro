...
export class AppComponent implements OnInit, OnDestroy {
  title = 'DeckGL IconLayer Issue - Angular 19';
  ...
  private initializeDeckGL() {
    console.log('🎨 Initializing DeckGL layers...');
    ...
    const layers = [
      ...
      // IconLayer - THIS IS THE PROBLEM: Icons do not render in Angular 19
      new IconLayer({
        id: 'icon-layer',
    ...
    console.log('🔍 EXPECTED: Red circles (ScatterplotLayer) + Blue camera icons (IconLayer)');
    console.log('❌ ACTUAL: Red circles render, but camera icons DO NOT render');
  }
